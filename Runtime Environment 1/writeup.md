...
After going through the disassembly briefly, we observe that the string at the top is of length 64 and there is some bit shifting to the right by various lengths followed by a logical AND operation by 0x3F or 63. Supporting our initial hunch that this could be some sort of custom base 64 encoding.
